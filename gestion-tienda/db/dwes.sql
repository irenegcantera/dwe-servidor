-- Creamos la base de datos CREATE DATABASE dwes DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish_ci; USE dwes; 
 
-- Creamos las tablas CREATE TABLE  dwes.tienda ( cod INT NOT NULL AUTO_INCREMENT PRIMARY KEY , nombre VARCHAR( 100 ) NOT NULL , tlf VARCHAR( 13 ) NULL ) ENGINE = INNODB; 
